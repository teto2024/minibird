...
**問題1: 薬草が生産できない**
- **影響する時代**: 青銅器時代以降
- **原因**: 薬草園 (herb_garden) の `produces_resource_id` が NULL に設定されている
- **現状**: 薬草園を建設しても薬草が生産されない
- **修正**: データベーススキーマを修正し、薬草園が薬草を生産するように設定

**問題2: ガラスが生産できない**
- **影響する時代**: 中世以降
- **原因**: ガラス工房 (glassworks) の `produces_resource_id` が NULL に設定されている
- **現状**: ガラス工房を建設してもガラスが生産されない
- **修正**: データベーススキーマを修正し、ガラス工房がガラスを生産するように設定
...
### 現代の建物
- **クリスタル鉱山** (💎) - クリスタルを採掘 ⚠️（特殊施設）
- **アパートメント** (🏢) - 現代的な集合住宅（人口+100）
- **空軍基地** (✈️) - 航空機を配備（軍事力+1000）
- **電子部品工場** (🔌) - 電子部品を製造 ⚠️（特殊生産施設）
- **シンクタンク** (🧠) - 戦略的研究機関（20/時）
