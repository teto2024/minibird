...
('titan_lv10', '巨神タイタン Lv10', '🦾', '大地を揺るがす巨大な巨人', 10, 10, 10, 1000000, 250, 90, 24),
('hydra_lv20', '九頭竜ヒュドラ Lv20', '🐍', '無数の首を持つ恐るべき蛇竜', 20, 20, 25, 5000000, 500, 150, 24),
('phoenix_lv30', '不死鳥フェニックス Lv30', '🔥', '炎の中から蘇る不死の鳥', 30, 30, 50, 15000000, 750, 240, 24),
('kraken_lv40', '海魔クラーケン Lv40', '🦑', '深海から現れる巨大なイカ', 40, 40, 100, 50000000, 1000, 300, 24),
('behemoth_lv50', '魔獣ベヒモス Lv50', '🦏', '世界を破壊する伝説の獣', 50, 50, 200, 150000000, 1500, 450, 24),
('chaos_dragon_lv60', '混沌龍カオス Lv60', '🐉', '混沌をもたらす最強のドラゴン', 60, 60, 400, 500000000, 2500, 600, 24),
('god_of_war_lv70', '戦神マルス Lv70', '⚔️', '戦争を司る神', 70, 70, 600, 1000000000, 3500, 900, 24),
('world_eater_lv80', '世界喰いジョルムンガンド Lv80', '🌍', '世界を飲み込む巨大な蛇', 80, 80, 1000, 3000000000, 5000, 1500, 24),
('void_lord_lv90', '虚無王 Lv90', '🌑', '虚無の次元から来た支配者', 90, 90, 2000, 10000000000, 7500, 2400, 24),
('cosmic_entity_lv100', '宇宙創造神 Lv100', '🌌', '宇宙を創造した超越的存在', 100, 100, 5000, 50000000000, 15000, 4500, 24);
